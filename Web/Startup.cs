...
public static class Startup
{
            ...
            options.AddSecurityRequirement(new OpenApiSecurityRequirement
    {
        ...
        builder.Services.AddTransient<IOnlineBronInterface, OnlineBronRepository>();
        builder.Services.AddScoped<IStaffInterface, StaffRepository>();
        builder.Services.AddScoped<IGuestInterface, GuestRepository>();
        builder.Services.AddScoped<IOrderInterface, OrderRepository>();
        builder.Services.AddScoped<IOrderStatusInterface, OrderStatusRepository>();
        ...
        builder.Services.AddScoped<IOrderStatusService, OrderStatusServices>();
